  ...
  <main class="shell">
    ...
    <aside class="panel">
      ...
      <div class="exportDock">
        ...
        <button id="exportButton" class="exportButton" data-i18n="exportAnimation" disabled>导出</button>
        <div class="progress">
